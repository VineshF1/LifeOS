...
async def get_current_user_id(
    ...
    """
    return (await get_current_user(credentials)).id
...
async def get_current_user(
    ...
    """Resolve tenant id + email from the Bearer token (DB-free, no cycle)."""
    ...
    try:
        ...
        return CurrentUser(id=UUID(str(payload["sub"])), email=str(payload["email"]))
