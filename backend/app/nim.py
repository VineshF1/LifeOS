...
async def chat_completion(
    ...
    *,
    ...
    """Single chat-completions turn against the configured agent model.

    Defaults to CHAT_MODEL (fast path); pass model=LLM_MODEL explicitly for
    heavyweight extraction.
    """
